          ...
          <div className="bg_Color mt-sm-4 pt-2">
            <div className="SinglePostD">
              <div className="Sdetails">
                ...
                <p>
                  {singleData.premiered} &nbsp;&nbsp;&nbsp; {singleData.runtime}
                  min/episode
                </p>
              </div>
            ...
            <div className="singleDimg d-flex">
              ...
              <div className="singleMainD m-5">
                <h6>
                  ...
                  {singleData.genres.join(", ")}
                </h6>
                <hr />
                <h6 className="text-light">
                  {removeHTMLtags(singleData.summary)}
                </h6>
                <hr />
                <h6>
                ...
                <hr />
                <h6>
                  <span className="text-light">Runtime: </span>
                  {singleData.runtime}m Per Episode
                </h6>
                <hr />
                <h6 className="hboIcon">
                  <span className="text-light">OfficialSite: </span>
                  <span className="hbo">
                    <a
                      href={singleData.officialSite}
                      target="_blank"
                ...
                <hr />
                <h6>
                  <span className="text-light">Tv Type: </span>
                  {singleData.type}
                </h6>
              </div>
            </div>
