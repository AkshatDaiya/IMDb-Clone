      ...
      <div className="contain">
        <div className="col-md-12 d-flex align-items-center justify-content-between position-fixed top-0 w-100 bg-black py-2 z-3">
          ...
          <div className="position-relative w-100 d-flex justify-content-center">
            <form
              className="SearchForm mx-2 w-75"
            ...
            >
              <input
                ...
                onChange={(e) => {
                  handleSearchedData(e.target.value);
                }}
              />
            </form>
            {searchedData && (
              <div
                className="position-absolute d-flex flex-column w-75 border border-1 bg-black rounded-3 p-3 overflow-y-scroll"
                style={{ top: "50px", height: "82vh" }}
              >
                {searchedData &&
                  searchedData.map((Data) => (
                    <button
                      className="text-white border border-1 p-1 m-1 fs-5 text-decoration-none bg-black text-center text-white"
              ...
              {!firstName ? (
                ...
                <button type="button">
                  ...
                  <ul className="navItem">
                    <li className="list py-4">
                      <Link
                        to="#"
                        className="lh-1 d-flex gap-1"
                      >
