                ...
                <div className="login">
                    ...
                    <div className="text">
                        ...
                        <div className='textDetails'>
                            <p>Your Watchlist</p>
                            <small>Track everything you want to watch and receive e-mail when movies open in theaters.</small>
                        </div>
                        <div className='textDetails'>
                            <p>Your Ratings</p>
                        ...
                        <div className='textDetails'>
                            ...
                            <small>Add data that will be seen by millions of people and get cool badges.</small>
                        </div>
                    </div>
                </div>
            </div>
